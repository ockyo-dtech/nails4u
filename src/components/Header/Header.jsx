          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pb-10 border-b-2 border-gray-200">
            ...
            <div class="hidden lg:flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
              <ul class="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
                ...
                <li>
                  <Link
                    to="/price-list" className="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-purple-700 focus-within:text-purple-700 focus-within:outline-0"
                  >
                    Price List
                  </Link>
                </li>
                ...
                <li>
                  <Link to="/contact" className="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-purple-700 focus-within:text-purple-700 focus-within:outline-0"
                  >
                    Contact
                  </Link>
                </li>
                <li>
                  <Link to="/support" className="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-purple-700 focus-within:text-purple-700 focus-within:outline-0"
                  >
                    Support
                  </Link>
                </li>
              </ul>
              <button class="py-3 pr-7 pl-5 rounded-xl flex items-center gap-2 text-base font-semibold text-purple-700 shadow-sm shadow-transparent bg-violet-50 transition-all duration-500 hover:bg-violet-200 focus-within:outline-0 focus-within:bg-violet-200 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
